...
const LetreiroDinamico: React.FC<{ filtros: any }> = ({ filtros }) => {
  ...
  return (
    <div className="flex items-center bg-[#0f1117] border-b border-[#2e3347] h-12 overflow-hidden shadow-2xl relative z-20 shrink-0">
      ...
      <div className="flex-1 flex items-center h-full px-10">
        <AnimatePresence mode="wait">
          ...
          >
            <span className="text-[11px] font-bold text-[#a0aec0] uppercase tracking-[0.2em]">
              {kpis[index].label}:
            </span>
      ...
      <div className="hidden md:flex items-center gap-3 px-6 border-l border-[#2e3347] h-full">
        <div className="flex flex-col items-end">
          <span className="text-[9px] font-bold text-[#a0aec0]">ENGINE IA 3.0</span>

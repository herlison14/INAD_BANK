...
const ProductView: React.FC<ProductViewProps> = ({ contracts, isDarkMode }) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-[#f0f4ff]">Visão por Produtos</h2>
      <p className="text-[#a0aec0]">Análise de inadimplência por produto.</p>
      
      <div className="bg-[#1a1f2e] p-4 rounded-lg shadow-none ring-1 ring-[#2e3347] transition-colors">
        <h3 className="font-semibold mb-4 text-[#cbd5e0]">Comparativo de Saldo Devedor por Produto</h3>
        <p className="text-xs text-[#a0aec0] mb-2 italic">* Passe o mouse sobre as barras para ver o nome do produto e valores detalhados.</p>

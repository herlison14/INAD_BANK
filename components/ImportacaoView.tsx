  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 animate-fade-in pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-[var(--surface-container)] p-8 rounded-[3.5rem] shadow-2xl flex flex-col justify-between text-[var(--text-primary)] relative overflow-hidden group border border-[var(--border-default)]">
                ...
                <div className="flex items-center gap-6 relative z-10 mb-8">
                    <div className="bg-[var(--brand-primary)]/10 p-4 rounded-3xl backdrop-blur-xl border border-[var(--brand-primary)]/20">
                        <FeatherIcon name="list" className="w-8 h-8 text-[var(--brand-primary)]" />
                    </div>
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-60 mb-1">Arquivos Auditados</p>
                        <p className="text-4xl font-black italic tracking-tighter leading-none text-[var(--brand-primary)]">{importHashes.length}</p>
                    </div>
                </div>
        ...
        <div className="bg-[var(--brand-primary)]/5 p-10 rounded-[3.5rem] border border-[var(--brand-primary)]/10 flex items-start gap-8">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-2">
                        <p className="text-[10px] font-black text-amber-500 uppercase tracking-widest border-b border-amber-200 dark:border-amber-900 pb-2">Protocolo Prejuízo:</p>
                        <div className="grid grid-cols-2 gap-2 text-[9px] font-bold uppercase text-amber-900 dark:text-amber-200">
                            <div>A: PA</div>
                            <div>B: Gerente</div>
                            <div>C: Sócio</div>
                            <div>D: CPF</div>

...
const DetalhamentoView: React.FC<DetalhamentoViewProps> = ({ contracts, initialSearchTerm, onNavigateToDetails, onSimulateRenegotiation, automationLogs, userRole }) => {
  ...
  return (
    <div className="space-y-6">
       <div className="bg-[var(--surface-container)] p-4 sm:p-6 rounded-3xl shadow-sm border border-[var(--border-default)] transition-colors">
        ...
        <p className="text-[var(--text-secondary)] mb-6 text-xs font-bold uppercase tracking-widest flex items-center gap-2">
      ...
      {initialSearchTerm && selectedLogs.length > 0 && (
          <div className="bg-[var(--surface-container)] p-8 rounded-3xl shadow-sm animate-fade-in transition-colors border border-[var(--border-default)]">

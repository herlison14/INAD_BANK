...
const SegmentacaoView: React.FC<SegmentacaoViewProps> = ({ contracts, isDarkMode }) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Segmentação por Produto</h2>
      <p className="text-gray-600 dark:text-gray-400">Análise dos indicadores de inadimplência agrupados por Produto.</p>
      
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-md transition-colors">
        <h3 className="font-semibold mb-4 text-gray-700 dark:text-gray-200">Saldo Devedor por Produto</h3>

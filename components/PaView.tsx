...
const PaView: React.FC<PaViewProps> = ({ contracts, isDarkMode }) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Visão por Posto de Atendimento (PA)</h2>
      <p className="text-gray-600 dark:text-gray-400">Análise de inadimplência por Posto de Atendimento.</p>
      
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-md transition-colors">
        <h3 className="font-semibold mb-4 text-gray-700 dark:text-gray-200">Comparativo de Saldo Devedor por PA</h3>
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-md transition-colors">
        <h3 className="font-semibold mb-4 text-gray-700 dark:text-gray-200">Detalhes por PA</h3>

...
const ManagerView: React.FC<ManagerViewProps> = ({ contracts, isDarkMode }) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-[#f0f4ff]">Visão por Gerente</h2>
      <p className="text-[#a0aec0]">Performance da carteira por gerente responsável.</p>
      
      <div className="bg-[#1a1f2e] p-4 rounded-lg shadow-none ring-1 ring-[#2e3347] transition-colors">
        <h3 className="font-semibold mb-4 text-[#cbd5e0]">Comparativo de Saldo Devedor por Gerente</h3>
      ...
      <div className="bg-[#1a1f2e] p-4 rounded-lg shadow-none ring-1 ring-[#2e3347] transition-colors">
        <h3 className="font-semibold mb-4 text-[#cbd5e0]">Detalhes por Gerente</h3>

...
const FeatherIcon: React.FC<{ name: string; className?: string }> = ({ name, className = "h-5 w-5" }) => {
    const icons: { [key: string]: React.ReactNode } = {
        ...
        'sparkles': <><path d="M12 3v1M12 20v1M3 12h1M20 12h1M18.36 5.64l-.7.7M6.34 17.66l-.7.7M5.64 5.64l.7.7M17.66 17.66l.7.7" /><path d="M9 12l2 2 4-4" /></>,

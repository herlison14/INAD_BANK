    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
      {metrics.map((m, idx) => (
        <motion.div 
          ...
          className="bg-[var(--surface-container)] border border-[var(--border-default)] p-8 rounded-[3.5rem] shadow-sm hover:shadow-xl transition-all group"
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-[9px] font-bold text-[var(--text-secondary)] uppercase tracking-widest">Métricas por Canal</p>
            </div>
          </div>
